...
public class UtilMethods {
   ...
   */
  public static Map<String,String> createAdvancedConfigFromJson(String jsonConfig, ObjectMapper mapper){

    return createTopicConfigurationRequestFromJson(jsonConfig, mapper).getAdvancedTopicConfiguration();
   ...
   */
  public static TopicConfigurationRequest createTopicConfigurationRequestFromJson(String jsonConfig, ObjectMapper mapper){
