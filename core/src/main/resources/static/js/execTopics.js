...
var app = angular.module('execTopicsApp',['sharedHttpInterceptor']);
    ...
    $scope.refreshPage = function(){
        ...
        $scope.execTopicRequestUp = function(topicId){
            $scope.showDeclinePanel = "false";
                swal({
                        title: "Are you sure?",
                        text: "You would like to approve the topic request ?",
                        type: "warning",
        ...
        $scope.execTopicRequestReject = function(reqNo) {
            ...
            reqNo = $scope.reqForDecline;
                    ...
                    swal({
                            title: "Are you sure?",
                            text: "You would like to decline the topic request ?",
                            type: "warning",
                            showCancelButton: true,
                            confirmButtonColor: "#DD6B55",
                            ...
                            if (isConfirm.value) {
                                $http({
                                        ...
                                        headers : { 'Content-Type' : 'application/json' },
                                        params: {'topicId' : reqNo, 'reasonForDecline' : reason },
