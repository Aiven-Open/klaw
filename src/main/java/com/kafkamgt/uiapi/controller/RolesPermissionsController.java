...
public class RolesPermissionsController {
    ...
    @RequestMapping(value = "/getRolesFromDb", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @RequestMapping(value = "/getPermissionDescriptions", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<HashMap<String, String>> getPermissionDescriptions() {
        return new ResponseEntity<>(rolesPermissionsControllerService.getPermissionDescriptions(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<HashMap<String, List<HashMap<String, Boolean>>>> getPermissions() {
        return new ResponseEntity<>(rolesPermissionsControllerService.getPermissions(true), HttpStatus.OK);
    }

    @PostMapping(value = "/deleteRole")
    public ResponseEntity<HashMap<String,String>> deleteRole(@RequestParam ("roleId") String roleId){
        return new ResponseEntity<>(rolesPermissionsControllerService.deleteRole(roleId), HttpStatus.OK);
    }
    ...
    public ResponseEntity<HashMap<String,String>> updatePermissions(@RequestBody KwRolesPermissionsModel[] kwRolesPermissionsModels){
        return new ResponseEntity<>(rolesPermissionsControllerService.updatePermissions(kwRolesPermissionsModels), HttpStatus.OK);
    }
