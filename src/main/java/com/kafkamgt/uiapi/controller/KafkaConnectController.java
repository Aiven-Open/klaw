...
public class KafkaConnectController {
  ...
  public ResponseEntity<HashMap<String, String>> createConnectorRequest(
      @Valid @RequestBody KafkaConnectorRequestModel addTopicRequest) throws KafkawizeException {
  ...
  */
  ...
  public ResponseEntity<HashMap<String, String>> approveTopicRequests(
      @RequestParam("connectorId") String connectorId) throws KafkawizeException {
    return new ResponseEntity<>(
