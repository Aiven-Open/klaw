...
import com.kafkamgt.uiapi.service.SaasService;
...
public class UsersTeamsController {
    ...
    @RequestMapping(value = "/getAllTeamsSUFromRegisterUsers", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<List<TeamModel>> getAllTeamsSUFromRegisterUsers() {
        return new ResponseEntity<>(usersTeamsControllerService.getAllTeamsSUFromRegisterUsers(), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> deleteUser(@RequestParam ("userId") String userId){
        ...
        return new ResponseEntity<>(usersTeamsControllerService.deleteUser(userId, true), HttpStatus.OK);
    }

    @PostMapping(value = "/updateUser")
    public ResponseEntity<String> updateUser(@Valid @RequestBody UserInfoModel updateUserObj){
        return new ResponseEntity<>(usersTeamsControllerService.updateUser(updateUserObj), HttpStatus.OK);
    }

    @PostMapping(value = "/updateProfile")
    public ResponseEntity<HashMap<String, String>> updateProfile(@Valid @RequestBody UserInfoModel updateUserObj){
        return new ResponseEntity<>(usersTeamsControllerService.updateProfile(updateUserObj), HttpStatus.OK);
    }

    @PostMapping(value = "/addNewUser")
    public ResponseEntity<HashMap<String, String>> addNewUser(@Valid @RequestBody UserInfoModel newUser) {
    ...
    public ResponseEntity<HashMap<String, String>> registerUser(@Valid @RequestBody RegisterUserInfoModel newUser) throws Exception{
        try {
            return new ResponseEntity<>(usersTeamsControllerService.registerUser(newUser, true), HttpStatus.OK);
        }catch (Exception e)
        {
            HashMap<String, String> resMap = new HashMap<>();
    ...
    public ResponseEntity<HashMap<String, String>> registerUserSaas(@Valid @RequestBody RegisterSaasUserInfoModel newUser) throws Exception{
        try {
    ...
    @RequestMapping(value = "/getActivationInfo", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<HashMap<String, String>> getActivationInfo(@RequestParam("userActivationId") String userActivationId) {
        return new ResponseEntity<>(saasService.getActivationInfo(userActivationId), HttpStatus.OK);
    }

    @RequestMapping(value = "/getNewUserRequests", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    ...
    @RequestMapping(value = "/getUserInfoFromRegistrationId", method = RequestMethod.GET, produces = {MediaType.APPLICATION_JSON_VALUE})
    public ResponseEntity<RegisterUserInfoModel> getRegistrationInfoFromId(@RequestParam("userRegistrationId") String userRegistrationId) {
        return new ResponseEntity<>(usersTeamsControllerService.getRegistrationInfoFromId(userRegistrationId, "STAGING"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> approveNewUserRequests(@RequestParam("username") String username) {
        return new ResponseEntity<>(usersTeamsControllerService.approveNewUserRequests(username, true, 0, ""), HttpStatus.OK);
    }
    ...
    public ResponseEntity<String> declineNewUserRequests(@RequestParam("username") String username) {
        return new ResponseEntity<>(usersTeamsControllerService.declineNewUserRequests(username), HttpStatus.OK);
    }

    @PostMapping(value = "/addNewTeam")
    public ResponseEntity<String> addNewTeam(@Valid @RequestBody TeamModel newTeam){
        return new ResponseEntity<>(usersTeamsControllerService.addNewTeam(newTeam, true), HttpStatus.OK);
    }
    ...
    public ResponseEntity<TeamModel> getTeamDetails(@RequestParam(value="teamId") Integer teamId,
                                                    @RequestParam(value="tenantName") String tenantName) {
        return new ResponseEntity<>(usersTeamsControllerService.getTeamDetails(teamId, tenantName), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<UserInfoModel>> showUsers(@RequestParam ("teamName") String teamName,
                                                         @RequestParam("pageNo") String pageNo,
                                                         @RequestParam(value = "searchUserParam", defaultValue = "") String searchUserParam){
        return new ResponseEntity<>(usersTeamsControllerService.showUsers(teamName, searchUserParam, pageNo), HttpStatus.OK);
    }
    ...
    public ResponseEntity<UserInfoModel> getUserDetails(@RequestParam(value="userId") String userId) {
        return new ResponseEntity<>(usersTeamsControllerService.getUserInfoDetails(userId), HttpStatus.OK);
    }

    @PostMapping(value = "/resetPassword")
    public ResponseEntity<HashMap<String, String>> resetPassword(@RequestParam ("username") String username){
