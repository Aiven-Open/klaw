...
//    private String acl_ssl;
    ...
    private ArrayList<@Pattern(message = "Invalid IP Address",
                regexp="^$|^(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(\\.(?!$)|$)){4}$") String> acl_ip;

    private ArrayList<@Pattern(message = "Invalid Principle", regexp="^$|^[a-zA-Z 0-9_.,=-]{3,}$") String> acl_ssl;
