...
//            env.get().setEnvExists("false");
    ...
    public void deleteTopics(Topic topic){
        ...
        List<Topic> topics = topicRepo.findAllByTopicnameAndEnvironmentAndTenantId(topic.getTopicname(), topic.getEnvironment(), topic.getTenantId());
    ...
    public void deleteConnectors(KwKafkaConnector connector){
        ...
        List<KwKafkaConnector> topics = kafkaConnectorRepo
                .findAllByConnectorNameAndEnvironmentAndTenantId(connector.getConnectorName(),
                        connector.getEnvironment(), connector.getTenantId());
        kafkaConnectorRepo.deleteAll(topics);
    }


    public String deleteRole(String roleId, int tenantId) {
        List<KwRolesPermissions> rolePerms = kwRolesPermsRepo.findAllByRoleIdAndTenantId(roleId, tenantId);
