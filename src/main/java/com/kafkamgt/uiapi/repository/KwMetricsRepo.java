...
public interface KwMetricsRepo extends CrudRepository<KwMetrics, Integer> {
    ...
    @Query(value ="select metricstime, metricsattributes from kwkafkametrics where " +
            " env=:envId and metricstype=:metricsType and metricsname=:metricsName" +
            " order by metricsid desc limit 30;", nativeQuery = true)
    List<Object[]> findAllByEnvAndMetricsTypeAndMetricsName(@Param("envId") String envId,
