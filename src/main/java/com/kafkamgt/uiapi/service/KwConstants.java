...
public class KwConstants {
  ...
  public static final String EMAIL_NOTIFICATIONS_ENABLED_KEY =
  ...
  public static final String INVALID_KEY_MESSAGE =
      "Invalid License !! Please request from https://kafkawize.io for a license key.";
