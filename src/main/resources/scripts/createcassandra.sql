...
Create table if not exists kafkamanagementapi.activitylog(req_no text PRIMARY KEY, activityname text, activitytype text, activitytime timestamp, details text, user text, env text);