...
public class ClusterApiServiceTest {
  ...
  public void getAllTopicsFailure() throws Exception {
    ...
    assertThrows(
        KafkawizeException.class, () -> clusterApiService.getAllTopics("", "PLAINTEXT", "", 1));
  }
  ...
  public void approveAclRequestsFailure() throws KafkawizeException {
    ...
    assertThrows(
        KafkawizeException.class, () -> clusterApiService.approveAclRequests(aclRequests, 1));
  }
