...
public class SelectDataJdbcTest {
    ...
    public void selectAclRequests() {
        ...
        List<AclRequests> aclRequestsActual = selectData.selectAclRequests(false, requestor,"","all",
        false, 1);
    ...
    public void selectTopicDetailsSuccess() {
        ...
        when(topicRepo.findAllByTopicnameAndTenantId(topicName, 1)).
    ...
    public void selectTopicRequests() {
        ...
        List<TopicRequest> topicRequestsActual = selectData.selectTopicRequestsByStatus(false, requestor,"", true, 1);
    ...
    public void selectAllUsersInfo() {
        ...
        when(userInfoRepo.findAllByTenantId(1)).thenReturn(utilMethods.getUserInfoList(username, "ADMIN"));
    ...
    public void selectActivityLog1() {
        ...
        when(activityLogRepo.findAllByEnvAndTenantId(anyString(), anyInt())).thenReturn(utilMethods.getLogs());
    ...
    public void selectTeamsOfUsers() {
        ...
        when(userInfoRepo.findAllByTenantId(anyInt())).thenReturn(utilMethods.getUserInfoList(username, "ADMIN"));
        ...
        when(userInfoRepo.findAllByTenantId(anyInt())).thenReturn(utilMethods.getUserInfoList(username, "SUPERUSER"));
