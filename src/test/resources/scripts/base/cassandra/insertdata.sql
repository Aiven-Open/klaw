...
Insert into kafkamanagementapi.teams(team,app,teammail,teamphone) values('Team3','Team3','t1@test3.com','+132323232');

/* Insert env */

Insert into kafkamanagementapi.env(name,host,port,protocol,type,other_params) values ('DEV','localhost','9092','PLAINTEXT','kafka','default.partitions=2,max.partitions=4,replication.factor=1');

Insert into kafkamanagementapi.env(name,host,port,protocol,type,other_params) values ('TST','localhost','9094','PLAINTEXT','kafka','default.partitions=2,max.partitions=4,replication.factor=1');

Insert into kafkamanagementapi.env(name,host,port,protocol,type,other_params) values ('ACC','localhost','9096','PLAINTEXT','kafka','default.partitions=2,max.partitions=4,replication.factor=1');

Insert into kafkamanagementapi.env(name,host,port,protocol,type,other_params) values ('PRD','localhost','9098','PLAINTEXT','kafka','default.partitions=2,max.partitions=4,replication.factor=1');
